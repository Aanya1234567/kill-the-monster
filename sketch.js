...
function setup() {
  ...
  box15 = new Box(744, 300, 70,70);
  box16 = new Box(744, 300, 70,70);
  box17 = new Box(744, 300, 70, 70);
  box18 = new Box(744, 300, 70, 70);
  box19 = new Box(744, 300, 70, 70);  
  box20 = new Box(744, 300, 70, 70);
  box21 = new Box(744, 300, 70, 70);
